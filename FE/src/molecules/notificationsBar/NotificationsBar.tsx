...
// Создаем интерфейс для ответа ошибки
interface ErrorResponse {
  error: string;
  // Можно добавить другие свойства, если они есть в ответе
}
// Дополните модель уведомления

const NotificationsBar: React.FC<NotificationsBarProps> = ({ userId }) => {
    ...
    const fetchNotifications = async () => {
      ...
      try {
        ...
        // console.error("Fetch error:", error);
          ...
          // Если ошибка существует, установим её в state, иначе установим стандартное сообщение
        setError(errorMessage || "An error occurred while fetching notifications");
